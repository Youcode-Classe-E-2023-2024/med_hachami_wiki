      ...
      <main>
        ...
        <?php foreach($data['categories']as $category) { ?>
          ...
          <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow bg-white rounded-md dark:bg-darker dark:border-gray-700">
            <span style="position: relative;left: 90%;top:8px;font-size: 18px;color: #fff;z-index: 100;cursor: pointer;display: none;"onclick="closeDropDown(<?php echo $category->id ?>)" id="closeBtn-<?php echo $category->id ?>">X</span>
  
            <div class="flex justify-end px-4 pt-4 dropdownContainer">

                <button id="dropdownButton-<?php echo $category->id ?>" onclick="openDropDown(<?php echo $category->id ?>)" data-dropdown-toggle="dropdown" class="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5" type="button">
                  ...
                  <!-- Dropdown menu -->
                  <div id="dropdown" data-dropdown-id="<?php echo $category->id ?>" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    
                      <ul class="py-2" aria-labelledby="dropdownButton">
                      
                      <li >
                          <a href="#" onclick="toggleModal2(event,<?php echo $category->id ?>)" class="block  px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Edit</a href="#">
                      </li>
                      
                      <li>
                          <a href="#" onclick="deleteModal(event,<?php echo $category->id ?>)" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</a>
                      </li>
                      </ul>
                  </div>
              </div>
              <div class="flex flex-col items-center pb-10 bg-white rounded-md dark:bg-darker">
                  <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white"><?php echo $category->name ?></h5>
                  <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo $category->description ?></span>
            ...
            <form >
                ...
                <div class="form fixed top-1/2 left-1/2 transform -translate-x-1/2 top-5 border border-gray-200  bg-white rounded-md dark:bg-darker">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        <div class="mb-5">
                            <label for="category" class="block mb-2 font-bold text-gray-600 uppercase">Category Name</label>
                        ...
                        <div class="mb-5">
                            <label for="category" class="block mb-2 font-bold text-gray-600 uppercase">Category Description</label>
                            <div class="relative border border-gray-300 text-gray-800 bg-white shadow-lg">
                        ...
                        <button name="submit" onclick="addNewCategory(event)" type="submit"  class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                            Add
                        </button>
                    </div>
                </div>
            ...
            <form >
                ...
                <div class="form fixed top-1/2 left-1/2 transform -translate-x-1/2 top-5 border border-gray-200  bg-white rounded-md dark:bg-darker">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <button name="submit" onclick="editCategory(event)" type="submit"  class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                            Edit
                        </button>
                    </div>
                </div>
        ...
        <div id="popup-modal3" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <form>
                        <input type="hidden" id="categoryIdDele" name="categoryIdDele" >
                        <div class="fixed top-1/2 left-1/2 transform -translate-x-1/2 top-5 border border-gray-200  bg-white rounded-md dark:bg-darker">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <button onclick="deleteCategory(event)" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                    Yes, I'm sure
                                </button>
                            </div>
                        </div>
