      ...
      >
        ...
        >
          Wiki-BackOffice
             ...
             <main id="log" >
                <div class="flex flex-col px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker" style="width: 40rem;height: 25rem;">
                    <h1 class="text-xl font-semibold text-center">Login</h1>
                    
                    <p class="text-red-700 text-2xl"><?php if( !empty($data['error'])) echo $data['error'];?></p>
                   
                    <form action="<?php echo URLROOT . '/Users/auth' ?>" method="POST" class="space-y-6">
                    <input
